<?php
    ...
    $data = [
        ...
        'date_service'          => empty($_POST['date_mise_en_service']) ? date('Y-m-d') : (string) $_POST['date_mise_en_service'],
        ...
        'id_raccordement'       => empty($_POST['id_raccordement']) ? null : (int) $_POST['id_raccordement'],
        'id_restriction'        => empty($_POST['id_restriction']) ? null : (int) $_POST['id_restriction'],
        'id_accessibilite'      => empty($_POST['id_accessibilite']) ? null : (int) $_POST['id_accessibilite'],
        'id_condition'          => empty($_POST['id_condition']) ? null : (int) $_POST['id_condition'],
